...
namespace XIVComboKamifiedPlugin
{
    ...
    internal class IconReplacer
    {
        ...
        private readonly XIVComboKamifiedConfiguration Configuration;
        ...
        public IconReplacer(DalamudPluginInterface pluginInterface, XIVComboKamifiedConfiguration configuration)
        {
            ...
            GetIconHook = new Hook<GetIconDelegate>(Address.GetIcon, new GetIconDelegate(GetIconDetour));
            IsIconReplaceableHook = new Hook<IsIconReplaceableDelegate>(Address.IsIconReplaceable, new IsIconReplaceableDelegate(IsIconReplaceableDetour));
        ...
        /// <summary>
        /// Maps to <see cref="XIVComboKamifiedConfiguration.EnabledActions"/>, these actions can potentially update their icon per the user configuration.
        /// </summary>
            ...
            */
            ...
            if (Configuration.IsEnabled(CustomComboPreset.MnkBasicTest))
            {
                if (actionID == MNK.Bootshine)
                {
                    ...
                    {
                        if (!TargetHasBuff(MNK.Debuffs.Demolish) && level >= MNK.Levels.Demolish)
                            return MNK.Demolish;
